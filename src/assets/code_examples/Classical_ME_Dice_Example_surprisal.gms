...
This file is similar to  "Classical_ME_Dice_Example.gms", but adds
analysis of the surprisal.
...
moments(t)   The data points - oberved moments
...
***Classical ME
* Base 2
*object_me..  obj =e= - sum(k,p(k)*log2((p(k)+1.e-8)));
* ln
object_me..  obj =e= - sum(k,p(k)*log((p(k)+1.e-8)));

*** p squared case for chapter 5
...
display  y, p.l , pme,  moments.m, H_ME, h_me, Max_H;
...
**** Place your file's location
execute_unload "Classical_ME_Dice_Example_surprisal.gdx" pme, pce, pel, pce1, q, h_me, h_ce, h_el, h_ce1;
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=pme rng=pme! Cdim=0 Rdim=1';
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=pce rng=pce! Cdim=0 Rdim=1';
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=pel rng=pel! Cdim=0 Rdim=1';
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=pce1 rng=pce1! Cdim=0 Rdim=1';
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=q rng=q! Cdim=0 Rdim=1';
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=h_me rng=pme!C1 Cdim=0 Rdim=0';
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=h_ce rng=pce!C1 Cdim=0 Rdim=0';
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=h_el rng=pel!C1 Cdim=0 Rdim=0';
execute 'gdxxrw.exe Classical_ME_Dice_Example_surprisal.gdx o=Classical_ME_Dice_Example_surprisal.xlsx par=h_ce1 rng=pce1!C1 Cdim=0 Rdim=0';
