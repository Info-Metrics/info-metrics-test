...
* Program generates a random data set
...
k      Number of independent variables  /x1*x4/
;
...
beta0(k)           correct ("unknown") betas             /x1  2
                                                          x2  1
                                                          x3 -3
                                                          x4  2
                                                         /
...
e(t)               Error
u(t)               Error for chi2 distribution
...
**Chi sq generator
*$ontext
u(t)=power(normal(0,1),2)+power(normal(0,1),2)+power(normal(0,1),2)+power(normal(0,1),2);
e(t)=(u(t)-4)/sqrt(8);
*$offtext
